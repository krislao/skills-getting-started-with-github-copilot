            ...
            <div class="participants">
              ...
              <ul>
                ${details.participants
                  .map(
                    (email) =>
                      `<li class="participant-item"><span>${email}</span><button type="button" class="delete-participant-button" data-activity="${name}" data-email="${email}" aria-label="Remove ${email}">×</button></li>`
                  )
                  .join("")}
              </ul>
            </div>
